...
```
$ cd
$ git clone https://github.com/mhhio/.tmux.git
...
```
$ git clone https://github.com/mhhio/.tmux.git "/path/to/oh-my-tmux"
...
[my own Vim configuration]: https://github.com/mhhio/.vim.git
